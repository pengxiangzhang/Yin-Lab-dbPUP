...
1. Rieske
   ...
   sulphide ions bridge the two iron ions forming a flat, rhombic cluster.

   Rieske-type iron-sulphur clusters are common to electron transfer chains of mitochondria and chloroplast and to
   non-haem iron oxygenase systems:

   &triangleright; The Rieske protein of the Ubiquinol-cytochrome c
   reductase ([1.10.2.2](http://www.ebi.ac.uk/intenz/query?cmd=SearchEC&ec=1.10.2.2)) (also known as the bc1 complex or
   ...
   &triangleright; The Rieske protein of chloroplastic plastoquinone-plastocyanin
...
[flavone](https://pubchem.ncbi.nlm.nih.gov/compound/flavone)

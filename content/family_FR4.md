# Functional Group Transfer Reactions (FRs) Family 4
...
This entry includes prenyltransferase-like proteins, including:
 ...
 \* Aromatic prenyltransferases NovQ from Streptomyces niveus and CloQ from Streptomyces roseochromogenes. They catalyse the transfer of a dimethylallyl group to 4-hydroxyphenylpyruvate to produce the ring A structure in the novobiocin and clorobiocin biosynthesis pathways, respectively[^2][^3].

 \* Flaviolin linalyltransferase from Streptomyces cinnamonensis. It is involved in the biosynthesis of furanonaphthoquinone I (FNQ I). It catalyses C- and O-prenylations of different phenolic substrates[^4][^5].
